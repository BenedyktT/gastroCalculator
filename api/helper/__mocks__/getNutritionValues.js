  ...
  try {
    return {
      ...
      totalDaily: {
        ...
        RIBF: {
          label: "Riboflavin (B2)",
          quantity: 96.69230769230771,
          unit: "%"
        },
        THIA: {
          label: "Thiamin (B1)",
          quantity: 43.416666666666664,
          unit: "%"
        },
        TOCPHA: { label: "Vitamin E", quantity: 28.371666666666666, unit: "%" },
        VITA_RAE: {
          label: "Vitamin A",
          quantity: 10.666666666666666,
          unit: "%"
        },
        VITB12: {
          label: "Vitamin B12",
          quantity: 345.8333333333333,
          unit: "%"
        },
        VITB6A: {
          label: "Vitamin B6",
          quantity: 232.46153846153845,
          unit: "%"
        },
